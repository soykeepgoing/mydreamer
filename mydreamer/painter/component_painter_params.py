...
from mydreamer.painter import (SparseCoordInit, RandomCoordInit, NaiveCoordInit, get_sdf)
from mydreamer.libs import get_optimizer
...
class CompPainter:
    ...
    def init_points_mask(self, num_paths, mask=None):
        # select points
        k = num_paths
