...
def split_svg(svg_path, output_path1, output_path2, out_size):
    # read svg to paths
    paths, attributes = svg2paths(svg_path)
    
    # split paths and attributes into two halves
    mid_index = len(paths) // 2
    paths1, attributes1 = paths[:mid_index], attributes[:mid_index]
    paths2, attributes2 = paths[mid_index:], attributes[mid_index:]
    
    # write split svgs to two output files
    wsvg(paths1,
